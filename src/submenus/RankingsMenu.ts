...
import RankingClientePorValor from '../negocio/rankingClientePorValor';
        ...
        while(true){
            ...
            switch(opcao){
                ...
                case 4:
                    ...
                    break
                case 5:
                    let rankingConsumoPorValor = new RankingClientePorValor(this.empresa.getVendas)
                    rankingConsumoPorValor.listar()
                    break
        }
